...
using Player.Application.Employees.Commands.DeleteEmployee;
using Player.Application.Employees.Commands.UpsertEmployee;
using Player.Application.Employees.Queries.GetEmployeeDetail;
using Player.Application.Employees.Queries.GetEmployeesList;
