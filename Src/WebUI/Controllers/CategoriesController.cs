...
using Player.Application.Categories.Commands.DeleteCategory;
using Player.Application.Categories.Commands.UpsertCategory;
using Player.Application.Categories.Queries.GetCategoriesList;
